...
function [Var1,Var2,X,Y,EndPts]=LinePlotTracks(TrackStruct,index,ScaleFactor,AxLimits)
...
B=TrackStruct(index).matrix(:,:,3);%Note +1.5 if in Fig2A! Fig offsets have to go here
